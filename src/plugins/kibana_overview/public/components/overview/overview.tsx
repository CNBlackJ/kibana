...
export const Overview: FC<Props> = ({ newsFetchResult, solutions, features }) => {
  ...
  const getSolutionGraphicURL = (solutionId: string) =>
    `/plugins/${PLUGIN_ID}/assets/solutions_${solutionId}_${IS_DARK_THEME ? 'dark' : 'light'
    }_2x.png`;
          ...
          <GettingStarted addBasePath={addBasePath} isDarkTheme={IS_DARK_THEME} apps={kibanaApps} />
            ...
            <>
              ...
              <EuiFlexGroup
                ...
                className={`kbnOverviewSupplements ${newsFetchResult && newsFetchResult.feedItems.length
                ...
                <EuiFlexItem grow={3}>
                  {solutions.length ? (
                    <section aria-labelledby="kbnOverviewMore__title" className="kbnOverviewMore">
                      ...
                      <EuiFlexGroup
                        className={`kbnOverviewData ${addDataFeatures.length === 1 && manageDataFeatures.length === 1
